...
//
// Compiles the Spout2 SDK source SpoutFrameCount.cpp inside this module with the engine's Windows guards.
...
#endif
#include "../../../ThirdParty/Spout2/SpoutGL/SpoutFrameCount.cpp"
#undef SendMessage
#undef PostMessage
#undef GetMessage
#undef MessageBox
