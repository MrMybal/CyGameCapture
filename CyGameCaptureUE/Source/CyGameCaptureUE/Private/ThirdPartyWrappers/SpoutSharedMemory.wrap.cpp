...
//
// Compiles the Spout2 SDK source SpoutSharedMemory.cpp inside this module with the engine's Windows guards.
...
#endif
#include "../../../ThirdParty/Spout2/SpoutGL/SpoutSharedMemory.cpp"
#undef SendMessage
#undef PostMessage
#undef GetMessage
#undef MessageBox
